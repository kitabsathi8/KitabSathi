      ...
      <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
        ...
        {user ? (
              ...
              <div style={{
                ...
                <div style={{ padding: "8px 10px 10px", borderBottom: `1px solid ${C.border}`, marginBottom: 6 }}>
                  <div style={{ fontSize: 13, fontWeight: 700, color: C.text }}>
                    {profile?.full_name || "KitabBazar User"}
                  </div>
                  <div style={{ fontSize: 11, color: C.muted, marginTop: 2 }}>{user.email}</div>
                  {profile?.whatsapp && (
                    <div style={{ fontSize: 11, color: C.muted, marginTop: 1 }}>📱 +977 {profile.whatsapp}</div>
                  )}
                </div>
                ...
                {[
                  ...
                  { label: "❤️ Saved Books",  href: "/saved"       },
          ...
          <Link href="/login" style={{
            padding: "8px 18px", background: C.primary, color: C.primaryDark,
            borderRadius: 20, fontSize: 14, fontWeight: 700,
            textDecoration: "none", marginLeft: 8, display: "inline-block",
          }}>
            Sign In
          </Link>
        )}
